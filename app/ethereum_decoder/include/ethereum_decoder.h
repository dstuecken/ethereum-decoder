#ifndef ETHEREUM_DECODER_ETHEREUM_DECODER_H
#define ETHEREUM_DECODER_ETHEREUM_DECODER_H
...
public:
    EthereumDecoder(std::unique_ptr<ABI> abi);
    ~EthereumDecoder() = default;
...
#endif // ETHEREUM_DECODER_ETHEREUM_DECODER_H